...
import { deleteInvoice, getInvoiceById, updatedInvoice as updateInvoice } from "@/app/actions"
...
const page = ({ params }: { params: { invoiceId: string } }) => {
    ...
    const handleSatusChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        const newSatus = parseInt(e.target.value)
        if (invoice) {
            const updatedInvoice = { ...invoice, status: newSatus }
            ...
            <div>
                <div className="flex flex-col md:flex-row md:justify-between items-center mb-4">
                    <p className="badge badge-ghost badge-lg uppercase">
                        <span>Facture-</span>{invoice?.id}</p>
                    ...
                    <div className="flex w-full md:w-1/3 flex-col">
                        <div className=" mb-4 bg-base-200 rounded-xl p-5">
                            ...
                            <div className="flex justify-between items-center mb-4">
                                <div className="badge badge-info">Résumer des Totaux</div>
